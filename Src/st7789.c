 ...
 * @return  none
 */
void ST7789_WriteChar(uint16_t x, uint16_t y, char ch, TFT_FontDef font, uint16_t color, uint16_t bgcolor)
{
	uint32_t i, b, j;
	ST7789_Select();
 ...
 * @return  none
 */
void ST7789_WriteString(uint16_t x, uint16_t y, const char *str, TFT_FontDef font, uint16_t color, uint16_t bgcolor)
{
	ST7789_Select();
	while (*str) {
...
void ST7789_Test(void)
{
	...
	HAL_Delay(1000);
	ST7789_WriteString(10, 20, "Speed Test", TFT_Font_11x18, RED, WHITE);
	HAL_Delay(1000);
	...
	ST7789_WriteString(10, 10, "Font test.", TFT_Font_16x26, GBLUE, WHITE);
	ST7789_WriteString(10, 50, "Hello Steve!", TFT_Font_7x10, RED, WHITE);
	ST7789_WriteString(10, 75, "Hello Steve!", TFT_Font_11x18, YELLOW, WHITE);
	ST7789_WriteString(10, 100, "Hello Steve!", TFT_Font_16x26, MAGENTA, WHITE);
	HAL_Delay(1000);

	ST7789_Fill_Color(RED);
	ST7789_WriteString(10, 10, "Rect./Line.", TFT_Font_11x18, YELLOW, BLACK);
	ST7789_DrawRectangle(30, 30, 100, 100, WHITE);
	HAL_Delay(1000);

	ST7789_Fill_Color(RED);
	ST7789_WriteString(10, 10, "Filled Rect.", TFT_Font_11x18, YELLOW, BLACK);
	ST7789_DrawFilledRectangle(30, 30, 50, 50, WHITE);
	HAL_Delay(1000);

	ST7789_Fill_Color(RED);
	ST7789_WriteString(10, 10, "Circle.", TFT_Font_11x18, YELLOW, BLACK);
	ST7789_DrawCircle(60, 60, 25, WHITE);
	HAL_Delay(1000);

	ST7789_Fill_Color(RED);
	ST7789_WriteString(10, 10, "Filled Cir.", TFT_Font_11x18, YELLOW, BLACK);
	ST7789_DrawFilledCircle(60, 60, 25, WHITE);
	HAL_Delay(1000);

	ST7789_Fill_Color(RED);
	ST7789_WriteString(10, 10, "Triangle", TFT_Font_11x18, YELLOW, BLACK);
	ST7789_DrawTriangle(30, 30, 30, 70, 60, 40, WHITE);
	HAL_Delay(1000);

	ST7789_Fill_Color(RED);
	ST7789_WriteString(10, 10, "Filled Tri", TFT_Font_11x18, YELLOW, BLACK);
